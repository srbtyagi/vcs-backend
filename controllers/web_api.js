...
app.get(
  "/vcsapi/api/generate/excel/appplicant/and/application/:f_date/:t_date/:user_id/:name",
  function (req, res) {
    // if (verifys == "verify") {
    async function apps() {
      try {
        ...
        async function excle() {
          var get = await generateExcelApplicantApplicationDetails(
            data1,
            data2
          );
          // //console.log(datask);
...
function generateExcelApplicantApplicationDetails(data, data2) {
  return new Promise(function (resolve, reject) {
    ...
    ws.cell(1, 1, 1, 12, true).string("Application List ").style(style);
    ...
    ws.cell(8, 2).string("Applicant Name").style(style1);
    ws.cell(8, 3).string("Email").style(style1);
    ws.cell(8, 4).string("Phone").style(style1);
    ws.cell(8, 5).string("Job Status").style(style1);
    ws.cell(8, 6).string("Application No").style(style1);
    ws.cell(8, 7).string("Date of Apply").style(style1);
    ws.cell(8, 8).string("Job Title").style(style1);
    ws.cell(8, 9).string("Application Status").style(style1);
    ...
    wb.write(
      `/home/ubuntu/vcs/excle_file/applicationdetails${data.created_by}.xlsx`,
      function (err) {
        if (err) resolve("err");
        else
          resolve(
...
app.get(
  "/vcsapi/generate/excle/invoice_recon/:acc_file_id/:user_id/:client_id/:name",
  function (req, res) {
    // if (verifys == "verify") {
    async function apps() {
      try {
        ...
        if (getname[0].user_middle_name === null) {
          user_name =
            getname[0].user_first_name + " " + getname[0].user_last_name;
        } else {
          user_name =
            getname[0].user_first_name +
            " " +
            getname[0].user_middle_name +
            " " +
            getname[0].user_last_name;
        }
        var data1 = {
          created_by: user_name,
        ...
        for (i in p) {
          ...
          if (
            ...
            isNaN(p[i].onb_regular_bill_rate) === false
          ) {
          ...
          if (
            p[i].onb_ot_bill_rate !== null &&
            isNaN(p[i].onb_ot_bill_rate) === false
          ) {
          ...
          if (
            ...
            isNaN(p[i].onb_holiday_bill_rate) === false
          ) {
          ...
          if (
            p[i].deducted_invoice_amt !== null &&
            isNaN(p[i].deducted_invoice_amt) === false
          ) {
          ...
          if (
            p[i].invoice_amt_clt !== null &&
            isNaN(p[i].invoice_amt_clt) === false
          ) {
...
function generateExcelInvoiceReconDatabyAccID(data, data2) {
  return new Promise(function (resolve, reject) {
    ...
    ws.column(17).setWidth(15);
    ws.column(18).setWidth(15);
    ws.cell(1, 1, 1, 7, true).string("Invoice Recon Report").style(style);
    ...
    ws.cell(7, 1).string("#").style(style1);
    ws.cell(7, 2).string("Week").style(style1);
    ws.cell(7, 3).string("Recruiter Name").style(style1);
    ws.cell(7, 4).string("Reg Bill Rate").style(style1);
    ws.cell(7, 5).string("OT Bill Rate").style(style1);
    ws.cell(7, 6).string("Holiday Bill Rate").style(style1);
    ws.cell(7, 7).string("Reg Hr").style(style1);
    ws.cell(7, 8).string("OT Hr").style(style1);
    ws.cell(7, 9).string("Holiday Hr").style(style1);
    ws.cell(7, 10).string("Invoice").style(style1);
    ws.cell(7, 11).string("Invoice(Ded)").style(style1);
    ws.cell(7, 12).string("Reg Hr(c)").style(style1);
    ws.cell(7, 13).string("OT Hr(c)").style(style1);
    ws.cell(7, 14).string("Holiday Hr(c)").style(style1);
    ws.cell(7, 15).string("Invoice(c)").style(style1);
    ws.cell(7, 16).string("Difference").style(style1);

    ws.cell(8, 1).number(1).style(style2);
    ...
    wb.write(
      `/home/ubuntu/vcs/excle_file/income_recon${data.year}${data.month}${data.created_by}.xlsx`,
      function (err) {
        if (err) resolve("err");
        else
          resolve(
...
app.post(
  "/vcsapi/insert/payroll_recon/data",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let count = 0;
          let checkaccountfile = await checkAccFile(
            req.body.data[0].acc_file_id
          );
...
app.post(
  "/vcsapi/get/invoice_recon/Byaccountfile",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/generate/excle/invoice_recon/:client_id/:user_id/:from_date/:to_date/:name",
  function (req, res) {
    // if (verifys == "verify") {
    async function apps() {
      try {
...
function generateExcelInvoiceReconData(data, data2) {
  return new Promise(function (resolve, reject) {
    ...
    ws.cell(9, 1).string("#").style(style1);
    ws.cell(9, 2).string("Week").style(style1);
    ws.cell(9, 3).string("Recruiter Name").style(style1);
    ws.cell(9, 4).string("Reg Bill Rate").style(style1);
    ws.cell(9, 5).string("OT Bill Rate").style(style1);
    ws.cell(9, 6).string("Holiday Bill Rate").style(style1);
    ws.cell(9, 7).string("Reg Hr").style(style1);
    ws.cell(9, 8).string("OT Hr").style(style1);
    ws.cell(9, 9).string("Holiday Hr").style(style1);
    ws.cell(9, 10).string("Invoice").style(style1);
    ws.cell(9, 11).string("Invoice(Ded)").style(style1);
    ws.cell(9, 12).string("Reg Hr(c)").style(style1);
    ws.cell(9, 13).string("OT Hr(c)").style(style1);
    ws.cell(9, 14).string("Holiday Hr(c)").style(style1);
    ws.cell(9, 15).string("Invoice(c)").style(style1);
    ws.cell(9, 16).string("Difference").style(style1);

    ws.cell(10, 1).number(1).style(style2);
...
app.get(
  "/vcsapi/get/api/allrecruiteedetails/:user",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/rec_details/and/recudetails",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
          ...
          if (p1.length > 0) {
            ...
            if (uu1 === "success") {
              ...
              if (rid.length > 0) {
                ...
                let p2 = await updateAllRecDetails(
                  rid[0].recruitee_id,
                  req.body
                );
                if (p2 === "success") {
...
app.post(
  "/vcsapi/update/api/rec_detailsandudetails",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/rec_work_hr/by/assignmentID/week_id/recruiteeID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/insert/api/canditate/skillset_map/data",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let checkifExistsCandidate = await checkEmailCandidate(
            req.body.candidateData.email
          );
          if (checkifExistsCandidate.length > 0) {
            let p1 = await updateCandidateData(
              req.body.candidateData,
              checkifExistsCandidate[0].candidate_id,
              uid
            );
            if (p1 === "success") {
          ...
          if (p2.length > 0) {
            ...
            if (checkSkillSet.length) {
              for (let i = 0; i < req.body.domainData.length; i++) {
                let checkDomainCategoryUnique = await checkDomainUnique(
                  req.body.domainData[i],
                  p2[0].candidate_id
                );
                ...
                if (checkDomainCategoryUnique.length) {
                  for (
                    let j = 0;
                    j < req.body.domainData[i]["skillset"].length;
                    j++
                  ) {
...
function insertskillsetMap(cID, data) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (data.skillset_rate === 0) {
      ...
      data.skillset_rate !== 0 &&
      data.date_of_completion === undefined
    ) {
...
app.get(
  "/vcsapi/get/api/skill_area/byall/activecatID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/skill_domain/skillset/by/skill_area_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          var sdomain = await getSkillDomainBySkillAreaID(
            req.body.skill_area_id
          );
          if (sdomain.length > 0) {
            for (i in sdomain) {
...
app.post(
  "/vcsapi/api/updateOrInsert/registration/user/application/guest/:exist/:user_id",
  function (req, res) {
    async function apps() {
        ...
        if (req.params.exist === "NO") {
          ...
          if (req.body.user_exist === "YES") {
            ...
            if (rid.length) {
              ...
              let add_appication = await addApplication(
                req.body,
                rid[0].recruitee_id,
                getLatestApplication_
              );
              if (add_appication === "success") {
                ...
                if (get_job_post_by.length > 0) {
                  let supervisor = await getSupervisor(
                    get_job_post_by[0].job_post_by
                  );
                  if (supervisor.length > 0 && supervisor[0].supervisor_name) {
                    let supervisor2 = await getSupervisor(
                      supervisor[0].supervisor_name
                    );
                    if (
                      supervisor2.length > 0 &&
                      supervisor2[0].supervisor_name
                    ) {
                      var j = {
                ...
                for (let k = 0; k < user_ids.length; k++) {
                  ...
                  var addIncen_perc = await updateAssignManagerIncentiveTable(
                    user_ids[k].user_id,
                    rid[0].recruitee_id,
                    getLApplication[0].application_id,
                    userRoleId
                  );
                }
                let addasgn_mgr = await updateAssignManagerTable(
                  req.body,
                  rid[0].recruitee_id,
                  getLApplication[0].application_id,
                  j
            ...
            let updateUser = await updateuserGuest(
              req.body,
              req.body.phone,
              email,
              req.params.user_id,
...
app.post(
  "/vcsapi/api/updateOrInsert/registration/user/application/guest/ByEmail",
  function (req, res) {
    async function apps() {
      try {
        //console.log(req.body)
...
app.post(
  "/vcsapi/get/payrollData/recruiteePayroll/filtered",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/approval_status/approved/accountfiledata",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/approval_status/approved/accountfiledata/download/excelfile/:user_id/:acc_file_id/:name",
  function (req, res) {
    // if (verifys == "verify") {
    async function apps() {
      try {
        ...
        if (post1[0].user_middle_name === null) {
          ...
          user_name =
            post1[0].user_first_name +
            " " +
            post1[0].user_middle_name +
            " " +
            post1[0].user_last_name;
        }
        var data1 = {
        ...
        for (var i = 0; i < post.length; i++) {
          ...
          var rec_name = "";
          if (
            post[i].user_middle_name === null ||
            post[i].user_middle_name === ""
          ) {
            rec_name = post[i].user_first_name + " " + post[i].user_last_name;
          } else {
            rec_name =
              post[i].user_first_name +
              " " +
              post[i].user_middle_name +
              " " +
              post[i].user_last_name;
          }
          data =
            data +
            rec_name +
...
function generateExcelFilePayrollInvoice(data, data2) {
  return new Promise(function (resolve, reject) {
    ...
    ws.cell(1, 1, 1, 7, true).string("Payroll Invoice Report").style(style);
    ...
    ws.cell(9, 1).string("#").style(style1);
    ws.cell(9, 2).string("Recruitee Name").style(style1);
    ws.cell(9, 3).string("Recruitee Code").style(style1);
    ws.cell(9, 4).string("Job ID").style(style1);
    ws.cell(9, 5).string("OT Starts After").style(style1);
    ws.cell(9, 6).string("Reg Bill Rate").style(style1);
    ws.cell(9, 7).string("OT Bill Rate").style(style1);
    ws.cell(9, 8).string("Holiday Bill Rate").style(style1);
    ws.cell(9, 9).string("Reg Pay Rate").style(style1);
    ws.cell(9, 10).string("OT Pay Rate").style(style1);
    ws.cell(9, 11).string("Holiday Pay Rate").style(style1);
    ws.cell(9, 12).string("Reg Hrs").style(style1);
    ws.cell(9, 13).string("Ot Hrs").style(style1);
    ws.cell(9, 14).string("Holiday Hrs").style(style1);
    ws.cell(9, 15).string("Total Hrs").style(style1);
    ws.cell(9, 16).string("Weekly perdiem").style(style1);
    ws.cell(9, 17).string("Bonus Amt").style(style1);
    ws.cell(9, 18).string("Taxable Income").style(style1);
    ws.cell(9, 19).string("Non-Taxable Income").style(style1);
    ws.cell(9, 20).string("Gross Income").style(style1);
    ws.cell(9, 21).string("comments").style(style1);
    ws.cell(9, 22).string("Invoice Amount").style(style1);
    ws.cell(9, 23).string("Deduction Percentage").style(style1);
    ws.cell(9, 24).string("Invoice (Aft. Ded.)").style(style1);
    ws.cell(9, 25).string("Misc. expense").style(style1);
    ws.cell(9, 26).string("Profit(#/wk)").style(style1);
    ...
    wb.write(
      "/home/ubuntu/vcs/excle_file/payroll_invoice.xlsx",
      function (err) {
        if (err) resolve("err");
...
app.post(
  "/vcsapi/add/or/update/api/tbl/payroll_invoice/calculate",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/all/inprocess/accountdatas",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          if (cdn.length > 0) {
            ...
            let insrt_account_file = await insertAccountFile(
              req.body,
              latestcdn
            );
            if (insrt_account_file === "success") {
              let latestcdn2 = await getLatestsAccountFile();
              let wks2 = await getAccountFiledata1(
                req.body,
                latestcdn2[0].acc_file_id
              );

              for (let i = 0; i < wks2.length; i++) {
                let post = await insertCalculatePayrollInvoice(
                  wks2[i],
                  latestcdn2[0].acc_file_id
                );
                if (post === "success") {
              ...
              if (count === wks2.length) {
                let wks = await getAccountFiledata(
                  req.body,
                  latestcdn2[0].acc_file_id
                );
                if (wks.length > 0) {
                  ...
                  res.json({
                    message: "hiring data is greater than wk_end_date.",
                    acc_file_id: latestcdn2[0].acc_file_id,
                  });
                }
              } else {
...
app.get(
  "/vcsapi/get/api/tbl/account_file/year",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/delete/account_file/byID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/payrollData/BYassignment",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/account_file/month/:year",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/account_file/weeks/:year/:month",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let wks = await getAccountFileweekallList(
            req.params.year,
            req.params.month
          );
          res.json(wks);
...
app.post(
  "/vcsapi/update/api/account_status/tbl/account_file",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/status/payroll/account_file",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
          ...
          if (post === "success") {
            ...
            if (postde === "success") {
              ...
              for (let i = 0; i < getPayrollDataByFile.length; i++) {
                ...
                if (getSum.length) {
                  let updateAssignment = await updateAssignmentWkHr(
                    getPayrollDataByFile[i],
                    getSum[0].sum
                  );
...
app.post(
  "/vcsapi/add/api/name/tbl/system_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/add/api/name/tbl/standard_document",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/name/tbl/system_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/assignment_status/tbl/assignment",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let get_assignment_status = await getAssignmentStatus(
          ...
          if (req.body.assignment_status === "working") {
            ...
            if (post === "success") {
              var post1 = await updateApplicationHiringDate(
                get_assignment_status[0].application_id,
                jsn
              );
              if (post1 === "success") {
                var post2 = await updateonboardData(
                  get_assignment_status[0].onboarding_id,
                  jsn
                );
                if (post2 === "success") {
                  var post3 = await updatepayrateData(
                    get_assignment_status[0],
                    jsn
                  );
                  if (post3 === "success") {
                    var post4 = await updatechangelogData(
                      get_assignment_status[0],
                      jsn
                    );
                    if (post4 === "success") {
            ...
            if (post === "success") {
              var post1 = await updateOnboardDataClose(
                get_assignment_status[0].onboarding_id,
                jsn
              );

              if (post1 === "success") {
                var post2 = await updatepayrateDataClose(
                  get_assignment_status[0],
                  jsn
                );

                if (post2 === "success") {
                  var post3 = await updatechangelogDataClose(
                    get_assignment_status[0],
                    jsn
                  );
...
app.post(
  "/vcsapi/update/api/name/tbl/standard_document",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/status/tbl/system_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/status/tbl/standard_document",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/standard_document/all",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/system_name/all",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/api/get/standard/document/by/doc_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/onboarding_status/completed/onboarding",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/onboarding_status/cancelled/onboarding",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/edit/api/change/user_status/delete/byApplicantID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/onboarding/hired/accepted",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
            ...
            if (onb_process1 === "success") {
              ...
              if (onb_process2 === "success") {
                ...
                if (rec_status === "success") {
                  let onb_appl_updt =
                    await updateOnboardindApplicationStatusHired(req.body);
...
function updateOnboardingStatusHired(data) {
  return new Promise(function (resolve, reject) {
    ...
    let post = {
      hiring_status: "hired",
      proposed_start_date: moment(new Date(data.hiring_date)).format(
        "MM/DD/YYYY"
      ),
      proposed_end_date: moment(new Date(data.closing_date)).format(
        "MM/DD/YYYY"
      ),
    };
...
app.get(
  "/vcsapi/get/api/assignment/and/client/data",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/standard/docby/IDs",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          if (get_recruitee.length) {
            checkIfexists = await getstdDocID(
              req.body.doc_id,
              get_recruitee[0].recruitee_id
            );
          }
...
app.post(
  "/vcsapi/get/api/facility/doc/byname",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let get_recruitee = await getRecruitee(req.body.user_id);
          if (get_recruitee.length) {
            checkIfexists = await getfacDocName(
              req.body.doc_name,
              get_recruitee[0].recruitee_id
            );
          }
...
app.post(
  "/vcsapi/get/api/other/doc/byname",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let get_recruitee = await getRecruitee(req.body.user_id);
          if (get_recruitee.length) {
            checkIfexists = await getothrDocName(
              req.body.doc_name,
              get_recruitee[0].recruitee_id
            );
          }
...
app.post(
  "/vcsapi/update/payrate_details/process/data",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
        ...
        try {
          ...
          if (application.length > 0 && application[0].application_id) {
            if (application[0].application_stage === "offered") {
              ...
              application[0].application_stage === "offer_accepted" ||
              application[0].application_stage === "onboarding" ||
              application[0].application_stage === "hired"
            ) {
              var onb_payrate1 = await updatePayRateDATA(req.body);
              if (onb_payrate1 === "success") {
                var getOnboard = await getOnboardData(req.body);
                var onb_update = await updateOnboardDATA(
                  req.body,
                  getOnboard[0].onboarding_id
                );
...
app.post(
  "/vcsapi/update/api/onboarding_details/onboarding/process",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          var arr = [];
          for (i in std_list) {
            var checkIfexsts = await getstdDocByrdID(
              std_list[i],
              req.body.recruitee_id
            );
          ...
          for (i in faclty_list) {
            var checkIfexsts = await getfacDocByrdName(
              faclty_list[i],
              req.body.recruitee_id
            );
            if (checkIfexsts.length > 0) {
          ...
          for (i in other_list) {
            var checkIfexists = await getothrDocByrdName(
              other_list[i],
              req.body.recruitee_id
            );
            if (checkIfexists.length > 0) {
          ...
          //console.log(arr);
          var onb_process = await updateOnboardindDetails(
            req.body,
            doc_id_list
          );
          if (onb_process === "success") {
            let onb_appl_updt = await updateOnboardindApplicationDetails(
              req.body
            );
            if (onb_appl_updt === "success") {
              res.json("success");
...
function updatePayRateDATA(data) {
  return new Promise(function (resolve, reject) {
    ...
    let post = {
      proposed_start_date: moment(new Date(data.proposed_start_date)).format(
        "MM/DD/YYYY"
      ),
      proposed_end_date: moment(new Date(data.proposed_end_date)).format(
        "MM/DD/YYYY"
      ),
...
app.post(
  "/vcsapi/get/api/all/job/data/onboarding/hired/offer_accepted",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/all/job/data/hired",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/recruitee/status/by/user_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/job/all/clients",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/tbl/job/all/city",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/job/all/state",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/job/all/country",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/tbl/job/search_job/with/filter",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          if (req.body.s1 === "" && req.body.s2 === "" && req.body.s3 === "") {
            ...
            var searchResultS1 = await getAllJobOfS1s2s3(
              req.body.s1,
              req.body.s2,
              req.body.s3
            );
            ...
            let set = new Set();
            var searchResultS3 = await getAllJobOfs2s3(
              req.body.s2,
              req.body.s3
            );
            if (searchResultS3.length) {
            ...
            let set = new Set();
            var searchResultS3 = await getAllJobOfs1s2(
              req.body.s1,
              req.body.s2
            );
            if (searchResultS3.length) {
            ...
            let set = new Set();
            var searchResultS3 = await getAllJobOfS1s3(
              req.body.s1,
              req.body.s3
            );
            if (searchResultS3.length) {
...
app.post(
  "/vcsapi/add/api/tbl/position_type",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/profession_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/profession_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/tbl/job/job/by/client_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/job_type_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/job_type_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/job_sector_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/job_sector_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/position_type",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/position_type_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/position_type_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/speciality_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/speciality_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/recruiter_id/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/teamLead_id/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/Manager_id/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/onb_mgr_id/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/insert/update/api/others/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/roles/by/application_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/insert/api/tbl/application",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
        ...
        try {
          ...
          if (rid.length > 0) {
            ...
            if (add_appication === "success") {
              ...
              if (updAppl === "success") {
                let get_job_post_by = await getJobpostby(
                  getLApplication[0].job_id
                );
                if (get_job_post_by.length > 0) {
                  let supervisor = await getSupervisor(
                    get_job_post_by[0].job_post_by
      ...
      async function apps() {
        try {
          ...
          if (adduadetail === "success") {
            ...
            if (getrid.length > 0) {
              let addradetail = await updateApplicantRecruiteeDetails(
                req.body,
                getrid[0].recruitee_id
              );
...
app.post(
  "/vcsapi/add/api/tbl/role/user_role",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/edit/api/change/role_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/JobNo/applicationlist",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/JobNo/suggestionList",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/application/searchBar",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/app_action_id_by_user_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/login_block_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/post/user_access_insert",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/user/already/applied/job",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/user/already/applied/job/ByEmail",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/post/app_user_access_insert",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/edit/api/change/role_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/module/submodules",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
//////////////////
app.post(
  "/vcsapi/add/api/tbl/user_access",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/candidate/by/userID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/add/api/tbl/employee/details",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let insertUserEmp = await addUserDetlForEmp(
            req.body,
            email.toLowerCase(),
            mbl_no,
            hashedPassword
          ...
          if (insertUserEmp === "success") {
            ...
            let add_employee = await addEmployee(
              req.body,
              getLatestUse[0].user_id
            );
...
app.post(
  "/vcsapi/get/action_id_by_user_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/all/employee/details",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/checkIfExists/designation/:designation_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  ...
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let getSup = await checkSupervisor(
            req.body.supervisor_code.trim().replace(/\s/g, "").toLowerCase()
          );
          if (getSup.length) {
            res.json("EXIST");
          } else {
...
app.post(
  "/vcsapi/update/api/tbl/company/details",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/api/tbl/company/details",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
////LCrB.D
app.get(
  "/vcsapi/get/api/department/byCID",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let get_department = await getDepartmentDetailsbyid(
            cdet[0].company_id
          );
          for (let i = 0; i < get_department.length; i++) {
            let get_user = await getEmpDepartmentbyid(
              get_department[i].dept_id
            );
  ...
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let cdet = await getCompanyDetails();
          let add_department = await addDepartmentDetails(
            req.body,
            cdet[0].company_id
          );
...
app.post(
  "/vcsapi/update/api/department_name",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let cdet = await getCompanyDetails();
          let update_department = await updateDepartmentDetails(
            req.body,
            cdet[0].company_id
          );
...
app.post(
  "/vcsapi/edit/api/change_status/department",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          let cdet = await getCompanyDetails();
          let deptstatus = await updateDepartmentStatus(
            req.body,
            cdet[0].company_id
          );
          res.json(deptstatus);
      ...
      async function apps() {
        try {
          ...
          for (let i = 0; i < get_jobPost.length; i++) {
            let get_job = await getapplicationjobPostCount(
              get_jobPost[i].job_id
            );
...
app.post(
  "/vcsapi/get/api/module/accesses/by/role_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
function addApplication(data, rid, pcode) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    /////////slice previous code
    if (pcode.length > 0) {
      var str = pcode[0].application_no
        .replace(/^'|'$/g, "")
        .split(/\s*\-\s*/g);
...
app.post(
  "/vcsapi/get/api/application/user_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/application/job_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/application/job_id/and/application_stage",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/application/review_status",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/application_stage/byJobID/sort_listed",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          for (i in application_ids) {
            var getApp = await updateApplicationStageSortListed(
              req.body,
              application_ids[i]
            );
          }
...
app.post(
  "/vcsapi/update/api/application_stage/byJobID/offeredORrejected",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/update/api/application_stage/byJobID/offer/accepted/OR/rejected",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          var getApp = await updateApplicationStageOfferAcceptededRejected(
            req.body
          );
          if (getApp === "success") {
            ...
            if (getpayrate.length) {
              if (req.body.application_stage === "offer_accepted") {
                var insertOnbDet = await insertOnbordingApplRecrut(
                  req.body,
                  getpayrate[0]
                );
                if (insertOnbDet === "success") {
                  let update = await updatePayRateStatus(
                    getpayrate[0].pay_rate_id
                  );
                  res.json(update);
                } else {
...
app.post(
  "/vcsapi/add/or/update/api/tbl/application/remarks/and/remarks_date",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
      async function apps() {
        try {
          ...
          let checkremarkdata = await getApplicationDataByJobIDandAppID(
            req.body
          );
          ...
          if (checkremarkdata.length > 0) {
            if (checkremarkdata[0].remarks === null) {
              ...
              var remarks =
                checkremarkdata[0].remarks + "&$&" + req.body.remarks;
              var remarkDate =
                checkremarkdata[0].remarks_date +
                "&$&" +
                moment(new Date(strTime)).format("MM/DD/YYYY");
            }
          }

          var getApp = await updateApplicationRemarkAndRemarkDate(
            req.body,
            remarks,
            remarkDate
          );
...
app.post(
  "/vcsapi/get/api/application/by/job_id_and_application_stage",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/api/application/by/job_id/sort_listed/or/rejected",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/all/inprocess/account/details",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/payroll/Byaccountfile",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/all/recruitee/name/payroll",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/all/recruitee/code/payroll",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/all/recruitee/payroll/search",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/get/acc_file/approved/week",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.post(
  "/vcsapi/generate/incentive/backlog",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
        ...
        try {
          ...
          for (let l = 0; l < req.body.data.length; l++) {
            ...
            for (let k = 0; k < getDistinctMonthYear.length; k++) {
              // count1=0;
              let getAccFile = await getAccFileData(
                getDistinctMonthYear[k],
                req.body.data[l]
              );
              ...
              let getAccData = await geAccountPayrollInfo(
                accFile.join(","),
                req.body.data[l]
              );
              if (getAccData.length) {
                ...
                for (let i = 0; i < getAccData.length; i++) {
                  let getAssignmentByRec = await getAssignmentByrecruitee(
                    getAccData[i]
                  );
                  ...
                  if (gemMinWeekID.length) {
                    if (
                      weekidlist.join(",").includes(gemMinWeekID[0].week_id)
                    ) {
                      let getwrkHrData = await getWrkHourMin(
                        gemMinWeekID[0].week_id,
                        getAccData[i]
                      );
                  ...
                  if (
                    getAssignmentByRec.length &&
                    getAssignmentByRec[0].sum - minhr >= 140
                  ) {
                    let getAccIncentive = await geAccountIncentiveData(
                      accFile.join(","),
                      getAccData[i]
                    );
                    ...
                    for (let j = 0; j < getAccIncentive.length; j++) {
                      ...
                      let net_margin_wk =
                        parseFloat(data.reg_hr) *
                          parseFloat(data.onb_regular_bill_rate) -
                        parseFloat(data.reg_hr) *
                          parseFloat(data.onb_regular_pay_rate) -
                        parseFloat(data.reg_hr) *
                          parseFloat(data.onb_regular_pay_rate) *
                          0.14 -
                        parseFloat(data.reg_hr) *
                      ...
                      let update = await updatePayrollStatus(
                        data.rec_payroll_id
                      );
                      if (update === "success") {
                    ...
                    for (let k = 0; k < userRoleData; k++) {
                      if (Number(userRoleData[k].role_id) === 1) {
                        var admin_inc_amount = Number(
                          userRoleData[k].incentive_percentage
                        );
                      } else if (Number(userRoleData[k].role_id) === 5) {
                        var recruiter_inc_amt = Number(
                          userRoleData[k].incentive_percentage
                        );
                      } else if (Number(userRoleData[k].role_id) === 9) {
                        var onb_mgr_inc_amt = Number(
                          userRoleData[k].incentive_percentage
                        );
                      } else if (Number(userRoleData[k].role_id) === 10) {
                        var tl_inc_amount = Number(
                          userRoleData[k].incentive_percentage
                        );
                      }
                    }
                ...
                if (recruiteeData.length) {
                  ...
                  let addincfile = await insertIncentiveFileData(
                    req.body,
                    req.body.data[l],
                    weekidlist.join(","),
                    getLincFile2,
                  ...
                  if (addincfile === "success") {
                    ...
                    for (let o = 0; o < recruiteeData.length; o++) {
                      let addinc = await insertIncentiveData(
                        getDistinctMonthYear[k],
                        getLincFile[0].inc_file_id,
                        recruiteeData[o],
                        req.body.data[l]
                      );
                      if (addinc === "success") {
      ...
      async function apps() {
        try {
          ...
          if (getAccData.length) {
            ...
            if (recruiteeData.length) {
              let getLincFile2 = await getLatestincFile();
              let addincfile = await insertIncentiveFile(
                req.body,
                getLincFile2
              );
              if (addincfile === "success") {
...
app.post(
  "/vcsapi/get/incentive/file/data",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
...
app.get(
  "/vcsapi/get/incentive/file/download/excel/:inc_file_id/:client_id/:user_id/:name",
  function (req, res) {
    async function apps() {
      try {
        ...
        if (getinc.length > 0) {
          for (let j = 0; j < getinc.length; j++) {
            ...
            let pay_amount = 0.0;
            let bill_amount = 0.0;
            let perc_pay_amount = 0.0;
            let perc_bill_amount = 0.0;
            let bonus = 0.0;
            for (let i = 0; i < payroll.length; i++) {
              ...
              if (getincrest.length > 0) {
                ...
                perc_pay_amount =
                  perc_pay_amount +
                  parseFloat(getincrest[0].reg_hr) *
                    parseFloat(getincrest[0].onb_regular_pay_rate) *
                    0.14;
                perc_bill_amount =
                  perc_bill_amount +
                  parseFloat(getincrest[0].reg_hr) *
                    parseFloat(getincrest[0].onb_regular_bill_rate) *
                    0.04;
                pay_amount =
                  pay_amount + parseFloat(getincrest[0].onb_regular_pay_rate);
                bill_amount =
                  bill_amount + parseFloat(getincrest[0].onb_regular_bill_rate);
        ...
        if (getinc[0].week_id_list === "") {
          ...
          for (k in wlistid) {
            ...
            if (sweekdata.length > 0) {
              var sd =
                "  " +
                sweekdata[0].wk_start_date +
                "-" +
                sweekdata[0].wk_end_date;
              weeklist.push(sd);
            }
          }
        ...
        if (details.length > 0) {
          ...
          for (i in details) {
            ...
            if (
              details[i].bill_amount !== null &&
              isNaN(details[i].bill_amount) === false
            ) {
            ...
            if (
              details[i].pay_amount !== null &&
              isNaN(details[i].pay_amount) === false
            ) {
            ...
            if (
              details[i].perc_pay_amount !== null &&
              isNaN(details[i].perc_pay_amount) === false
            ) {
            ...
            if (
              details[i].perc_bill_amount !== null &&
              isNaN(details[i].perc_bill_amount) === false
            ) {
            ...
            if (
              details[i].bonus !== null &&
              isNaN(details[i].bonus) === false
            ) {
            ...
            if (
              details[i].incentive.net_margin !== null &&
              isNaN(details[i].incentive.net_margin) === false
            ) {
            ...
            if (
              details[i].incentive.recruiter_inc_amt !== null &&
              isNaN(details[i].incentive.recruiter_inc_amt) === false
            ) {
            ...
            if (
              details[i].incentive.tl_inc_amount !== null &&
              isNaN(details[i].incentive.tl_inc_amount) === false
            ) {
            ...
            if (
              details[i].incentive.admin_inc_amount !== null &&
              isNaN(details[i].incentive.admin_inc_amount) === false
            ) {
            ...
            if (
              details[i].incentive.onb_inc_amount !== null &&
              isNaN(details[i].incentive.onb_inc_amount) === false
            ) {
            ...
            if (details[i].names.user_middle_name === null) {
              rec_name =
                details[i].names.user_first_name +
                " " +
                details[i].names.user_last_name;
            } else {
              rec_name =
                details[i].names.user_first_name +
                " " +
                details[i].names.user_middle_name +
                " " +
                details[i].names.user_last_name;
            }
            let recruiter_name = "";
            if (details[i].names.recruiter_middle_name === null) {
              recruiter_name =
                details[i].names.recruiter_first_name +
                " " +
                details[i].names.recruiter_last_name;
            } else {
              recruiter_name =
                details[i].names.recruiter_first_name +
                " " +
                details[i].names.recruiter_middle_name +
                " " +
                details[i].names.recruiter_last_name;
            }
            let teamlead_name = "";
            if (details[i].names.team_lead_middle_name === null) {
              teamlead_name =
                details[i].names.team_lead_first_name +
                " " +
                details[i].names.team_lead_last_name;
            } else {
              teamlead_name =
                details[i].names.team_lead_first_name +
                " " +
                details[i].names.team_lead_middle_name +
                " " +
                details[i].names.team_lead_last_name;
            }
            let onb_name = "";
            if (details[i].names.onboard_middle_name === null) {
              onb_name =
                details[i].names.onboard_first_name +
                " " +
                details[i].names.onboard_last_name;
            } else {
              onb_name =
                details[i].names.onboard_first_name +
                " " +
                details[i].names.onboard_middle_name +
                " " +
                details[i].names.onboard_last_name;
            }
            let manager_name = "";
            if (details[i].names.manager_middle_name === null) {
              manager_name =
                details[i].names.manager_first_name +
                " " +
                details[i].names.manager_last_name;
              manager_name =
                details[i].names.manager_first_name +
                " " +
                details[i].names.manager_middle_name +
                " " +
                details[i].names.manager_last_name;
            }
            data =
...
function generateExcelIncentiveData(data, data2) {
  return new Promise(function (resolve, reject) {
    ...
    ws.column(17).setWidth(15);
    ws.column(18).setWidth(15);
    ws.cell(1, 1, 1, 7, true).string("Incentive Report").style(style);
    ws.cell(3, 1, 3, 7, true)
      .string("Client              : " + data.client)
      .style(style3);
    ws.cell(4, 1, 4, 12, true)
    ...
    ws.cell(11, 1).string("#").style(style1);
    ws.cell(11, 2).string("Recruitee Name").style(style1);
    ws.cell(11, 3).string("Recruiter Name").style(style1);
    ws.cell(11, 4).string("Team Lead Name").style(style1);
    ws.cell(11, 5).string("Onboarding Name").style(style1);
    ws.cell(11, 6).string("Manager Name").style(style1);
    ws.cell(11, 7).string("Month Start Date").style(style1);
    ws.cell(11, 8).string("Month End Date").style(style1);
    ws.cell(11, 9).string("Bill Amount(Reg)").style(style1);
    ws.cell(11, 10).string("Pay Amount(Reg)").style(style1);
    ws.cell(11, 11).string("14% of Pay Amt").style(style1);
    ws.cell(11, 12).string("4% of Bill Amt").style(style1);
    ws.cell(11, 13).string("Bonus").style(style1);
    ws.cell(11, 14).string("Net Margin").style(style1);
    ws.cell(11, 15).string("Recruiter Incentive(7%)").style(style1);
    ws.cell(11, 16).string("TL Incentive(3%)").style(style1);
    ws.cell(11, 17).string("Admin Incentive(2%)").style(style1);
    ws.cell(11, 18).string("Onboarding Incentive(0.75%)").style(style1);

    ws.cell(12, 1).number(1).style(style2);
    ...
    wb.write(
      `/home/ubuntu/vcs/excle_file/incentive${data.year}${data.month}${data.created_by}.xlsx`,
      function (err) {
        if (err) resolve("err");
        else
          resolve(
...
app.post(
  "/vcsapi/skilldata/by/candidate_id",
  stuff.verifyToken,
  stuff.verify,
  function (req, res) {
    if (verifys == "verify") {
